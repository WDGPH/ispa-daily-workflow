...
from ispa_daily_workflow.diff import run_daily_diff_from_compliance_history
...
from ispa_daily_workflow.pipeline.daily_publish import publish_stage
...
def process_stage(
    *,
    ...
    for paths in written_combined.values():
